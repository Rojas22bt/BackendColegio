"""
Django settings for ColegioBK project.
...
SECRET_KEY = 'django-insecure-c+1up$du$6-nvyxrzv(emtk)@1ni!+r1i1^mjh$zyhbt)ck^3-'
...
WSGI_APPLICATION = 'ColegioBK.wsgi.application'
...
APPEND_SLASH = False  # Para evitar redirecciones que puedan causar problemas
CORS_ALLOWED_ORIGINS = [
    "https://venerable-palmier-c7fb94.netlify.app",
]
