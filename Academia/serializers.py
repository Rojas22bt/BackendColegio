from BaseDatosColegio.models import Curso,Paralelo,Nivel,Horario,Materia,CursoParalelo,MateriaAsignada,DescripcionMateria,HorarioMateria,Libreta, AlumnoCursoParalelo
